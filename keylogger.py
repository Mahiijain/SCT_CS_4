...
# # Function to write keystrokes to the log file with a timestamp
...
# # Function to choose the log file location
# def choose_log_file():
#     global log_file
...
# # Function to view the log file within the application
# def view_log():
...
# # Create start button
# start_button = tk.Button(root, text="Start Logging", command=start_logging, width=20, bg="green", fg="white")
# start_button.pack(pady=10)

# # Create stop button
# stop_button = tk.Button(root, text="Stop Logging", command=stop_logging, width=20, bg="red", fg="white", state="disabled")
# stop_button.pack(pady=10)

# # Create choose log file button
# choose_file_button = tk.Button(root, text="Choose Log File", command=choose_log_file, width=20, bg="blue", fg="white")
# choose_file_button.pack(pady=10)

# # Create view log button
# view_log_button = tk.Button(root, text="View Log", command=view_log, width=20, bg="purple", fg="white")
# view_log_button.pack(pady=10)

# # Create a label to display the status
# status_label = tk.Label(root, text="Not logging...", fg="black")
...
def draw_gradient(canvas, color1, color2):
    ...
    for i in range(256):
        color = f"#{i:02x}{(255-i):02x}{(128+i//2):02x}"  # Create a gradient color
